...
location_df = pickle.load(open("datasets/location_distance1.pkl",'rb'))

#st.dataframe(location_df)


cosine_sim1 = pickle.load(open("datasets/cosine_sim11.pkl",'rb'))
cosine_sim2 = pickle.load(open("datasets/cosine_sim22.pkl",'rb'))
cosine_sim3 = pickle.load(open("datasets/cosine_sim33.pkl", 'rb'))
